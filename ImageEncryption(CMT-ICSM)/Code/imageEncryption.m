...
imgDst=ImageCipher(imgDst,'encryption');
...
load K.mat;
 if EncryWay==1  
 imgDst=ImageCipher(imgDst,'decryption',K);
 end
...
% --- Executes during object creation, after setting all properties.
 function imageSrc_hist_CreateFcn(hObject, eventdata, handles)
% hObject    handle to imageSrc_hist (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called

% Hint: place code in OpeningFcn to populate imageSrc_hist


% --- Executes on mouse press over axes background.
 function imageSrc_hist_ButtonDownFcn(hObject, eventdata, handles)
% hObject    handle to imageSrc_hist (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
